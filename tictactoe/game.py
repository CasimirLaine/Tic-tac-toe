...
class Game:
    ...
    def play_one_turn(self):
        if self.is_game_over():
            return
        self.get_player_with_turn().move()
    ...
    def get_winner(self):
        return self.get_player_with_turn() if self.grid.has_full_row() else None

    def get_player_with_turn(self):
        return self.player_1 if not self.turns % 2 else self.player_2
